...
server.on('request',function(req,res){
    ...
    if(url_1==='images'){
        res.writeHead(200,{'Content-Type':'image/jpeg'});
        if(url_2 !== 'img'){
            fs.readFile('./images/'+url_2,'binary',function(err,data){
                if(err){
                    throw err ;
                }else{
                    res.write(data,'binary');
            ...
            fs.readFile('./images/img/'+url.split('/')[3],'binary',function(err,data){
                if(err){
                    throw err ;
                }else{
                    res.write(data,'binary');
    ...
    if(url_1==='css'){
        ...
        fs.readFile('./css/'+url_2,function(err,data){
            if(err){
                throw err ;
            }    
           res.write(data.toString());
